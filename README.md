...
<p align="center">
  <b>Projeto desenvolvido comreact; typescript; tailwind; vite; speechrecognition api; radix ui; date-fns; sonner.</b>
</p>
...
```bash
git clone https://github.com/guedescss/notes-expert
```
