  ...
  function handleStopRecording() {
    ...
    return (
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] bg-slate-700 md:rounded-md flex flex-col outline-none h-[60vh] w-full">
        ...
        {shouldShowOnboarding ? (
          ...
          <textarea onChange={handleContentChange} autoFocus className="text-sm leading-6 text-slate-400 bg-transparent resize-none flex-1 outline-none" value={content}/>
        ) }
